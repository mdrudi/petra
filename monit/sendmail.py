...
def send_mail(send_from,send_to, subject, html, server = "localhost"):
   COMMASPACE = ', '
   msg = MIMEMultipart('alternative')
   msg['From'] = 'EKMAN <'+send_from+'>'
...
<html>
 ...
 <body>
   <p>{code} check every ~30':<br>
    ...
    #print htmlcode
    send_mail(sender,receivers,module+" monit Ekman e-mail ",htmlcode)
